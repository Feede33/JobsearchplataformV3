...
export default function browserConsole(): Plugin {
  return {
      ...
      return html.replace(
        ...
        `<script>
          ...
          window.console = {
            ...
            debug: (...args) => {
              originalConsole.debug ? originalConsole.debug(...args) : originalConsole.log(...args);
              fetch('/browser-log', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ type: 'debug', args })
              }).catch(() => {});
            }
          };
            ...
            try {
              ...
              switch (type) {
                ...
                case 'info':
                  ...
                  break;
                case 'debug':
                  console.log('\x1b[90m[Browser Debug]\x1b[0m', ...args);
                  break;
