...
const CompanyJobManagement: React.FC = () => {
  ...
  useEffect(() => {
    const fetchCompanyProfile = async () => {
      ...
      try {
        ...
        // Actualizar formData con la información de la empresa
        setFormData(prev => ({
          ...prev,
  ...
  useEffect(() => {
    const fetchJobs = async () => {
      ...
      try {
        // Obtener los trabajos publicados por esta empresa
        ...
        // Para cada trabajo, obtener el número de aplicaciones
        const jobsWithApplications = await Promise.all(
          (jobsData || []).map(async (job) => {
            ...
            if (countError) {
              console.error("Error al contar aplicaciones:", countError);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!user?.id || !companyProfile) {
      toast({
        title: "Error",
        description: "Debes completar tu perfil de empresa primero.",
        variant: "destructive",
      });
      setLoading(false);
      return;
    ...
    try {
      ...
      toast({
        title: selectedJob ? "Trabajo actualizado" : "Trabajo publicado",
        description: `El trabajo "${formData.title}" ha sido ${
          selectedJob ? "actualizado" : "publicado"
        } exitosamente.`,
      });
    ...
    return (
      <div className="container mx-auto p-6">
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Debes completar tu perfil de empresa antes de publicar trabajos.
          </AlertDescription>
        </Alert>
  ...
  return (
    <div className="container mx-auto p-6">
      <h1 className="text-3xl font-bold mb-6">Gestión de Ofertas Laborales</h1>

      <Tabs defaultValue="list" className="w-full">
        <TabsList className="mb-4">
          <TabsTrigger value="list">Mis Ofertas Publicadas</TabsTrigger>
          <TabsTrigger value="form">
            {selectedJob ? "Editar Oferta" : "Publicar Nueva Oferta"}
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="list">
          <div className="grid gap-4">
            ...
            {!loading && jobs.length === 0 && (
              <p>No has publicado ninguna oferta laboral. ¡Publica tu primera oferta!</p>
            )}
        ...
        <TabsContent value="form">
          <Card>
            <CardHeader>
              <CardTitle>
                {selectedJob ? "Editar Oferta Laboral" : "Publicar Nueva Oferta Laboral"}
              </CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <Label htmlFor="is_featured">Destacar oferta</Label>
                  </div>
                </div>
