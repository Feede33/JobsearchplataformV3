...
interface PersonalizedJobListingCardProps {
  id: string;
  companyLogo: string;
  jobTitle: string;
  companyName: string;
...
const PersonalizedJobListingCard = ({
  id,
  companyLogo,
  jobTitle,
  companyName,
  ...
  className = "",
  onClick,
}: PersonalizedJobListingCardProps) => {
  ...
  useEffect(() => {
    const checkInteractions = async () => {
      if (isAuthenticated && user) {
        console.log("PersonalizedJobListingCard - Verificando interacciones para jobId:", id);
        ...
        <div className="mt-auto pt-4 border-t border-gray-100">
          ...
          <div className="flex justify-between items-center gap-2">
            <div className="flex items-center gap-3">
              {/* Botón circular para compartir - TAMAÑO MODIFICADO */}
              <TooltipProvider>
                <Tooltip>
              ...
              {/* Botón circular para guardar - TAMAÑO MODIFICADO */}
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
            ...
            {/* Botón de aplicar más pequeño */}
            <Button
              variant={isApplied ? "outline" : "default"}
              size="sm"
              className={`${isApplied ? "text-green-600 border-green-300 hover:bg-green-50" : ""} text-xs h-8`}
...
export default PersonalizedJobListingCard; 